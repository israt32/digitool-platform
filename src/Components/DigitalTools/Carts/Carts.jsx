  ...
  return (
    <div className="border-2 border-[#F2F2F2] rounded-2xl p-10">
      ...
      {cartNumber.length > 0 ? (
        ...
        <div className="bg-[#d0d0d0a7] flex flex-col justify-center items-center p-32 rounded-2xl">
          <img className="w-12 mb-3.5" src={shoppingCart} alt="" />
          <p className="text-2xl font-semibold text-[#627382]">Your Cart is empty</p>
        </div>
      )}
    </div>
  );
